...
public class AttendanceAgent {
  ...
  public AttendanceAgent(
      Gemini geminiModel,
      @Qualifier("attendanceMcpToolset") McpToolset attendanceMcpToolset) {
  ...
  public BaseAgent build() {
    return LlmAgent.builder()
        ...
        .description("Primary attendance operations agent. Handles attendance records, calculations, summaries, trends and reports through the Attendance MCP Server.")
        .instruction("""
