...
public class OrchestratorAgentClient {
  ...
  public OrchestratorAgentClient(AttendanceAiProperties properties, A2AAgentClientSupport support) {
    this.properties = properties;
    this.support = support;
  }

  public Map<String, Object> sendAttendanceResult(String date, Object attendanceResult) {
