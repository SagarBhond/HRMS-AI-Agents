...
public class NotificationAgentClient {
  ...
  /**
   * Thin FunctionTool bridge. The actual operation is performed by the dedicated A2A agent.
   * The actual email/notification is performed by Notification Agent over A2A.
   */
  public Map<String, Object> sendLeaveEmail(
    ...
    authorizationService.requireSelfOrPrivileged(
        requesterEmployeeId, requesterRole, employeeId);
