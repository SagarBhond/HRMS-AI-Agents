...
public class DocumentTools {
  ...
  public DocumentRecord createDocument(
      String documentType, Long employeeId, String title, String content) {
  ...
  public DocumentRecord storeDocument(
      String documentType, Long employeeId, String title, String content) {
    return save(documentType, employeeId, title, content, "STORED");
  }

  private DocumentRecord save(
      String type, Long employeeId, String title, String content, String format) {
    long id = ids.getAndIncrement();
    DocumentRecord d =
        new DocumentRecord(id, employeeId, title, type, format, content, Instant.now().toString());
    documents.put(id, d);
    return d;
  }
