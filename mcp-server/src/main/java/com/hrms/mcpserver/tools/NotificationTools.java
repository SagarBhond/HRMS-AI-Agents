...
public class NotificationTools {
  ...
  public NotificationRecord sendEmployeeNotification(Long employeeId, String subject, String message) {
    return send("EMPLOYEE", String.valueOf(employeeId), subject, message);
  }

  @Tool(description = "Send a manager notification")
  public NotificationRecord sendManagerNotification(Long managerEmployeeId, String subject, String message) {
  ...
  private NotificationRecord send(String channel, String recipient, String subject, String message) {
    NotificationRecord r = new NotificationRecord(ids.getAndIncrement(), channel, recipient, subject, message, Instant.now().toString(), "ACCEPTED");
    sent.add(r);
    return r;
  }

  public record NotificationRecord(Long notificationId, String channel, String recipient,
                                   String subject, String message, String createdAt, String status) {}
}
