...
public class HrTools {
  ...
  public HR recordOnboarding(
    ...
    return saveEvent(employeeId, HR.LifecycleEventType.ONBOARDING, eventDate, details);
  }
  ...
  public HR recordPromotion(
    ...
    return saveEvent(employeeId, HR.LifecycleEventType.PROMOTION, eventDate, details);
  }
  ...
  public HR recordTransfer(
    ...
    employeeRepository.save(employee);
    return saveEvent(employeeId, HR.LifecycleEventType.TRANSFER, eventDate, details);
  }
  ...
  public HR recordExit(
    ...
    return saveEvent(employeeId, HR.LifecycleEventType.EXIT, eventDate, details);
  }

  @Tool(description = "Get the full lifecycle event history for an employee")
  public List<HR> getLifecycleHistory(@ToolParam(description = "Employee ID") Long employeeId) {
    return lifecycleEventRepository.findByEmployeeId(employeeId);
  }

  private HR saveEvent(
      Long employeeId, HR.LifecycleEventType type, LocalDate eventDate, String details) {
    HR event =
        HR.builder()
