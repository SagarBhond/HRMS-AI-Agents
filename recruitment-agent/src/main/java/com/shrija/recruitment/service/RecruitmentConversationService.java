package com.shrija.recruitment.service;
...
import com.shrija.recruitment.dto.RecruitmentChatRequest;
import com.shrija.recruitment.exception.RecruitmentAgentExecutionException;
import java.util.UUID;
import org.springframework.stereotype.Service;

@Service
public class RecruitmentConversationService
{
    private final RecruitmentAgent agent;

    public RecruitmentConversationService(RecruitmentAgent agent)
    {
        this.agent = agent;
    }

    public Result converse(RecruitmentChatRequest r)
    {
        try
        {
        ...
        {
            throw new RecruitmentAgentExecutionException("Recruitment agent execution failed", e);
        }
    }
