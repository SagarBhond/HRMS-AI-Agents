...
public class PerformanceAgentClient {
  ...
  public String getTeamPerformanceSummary(String managerEmployeeId) {
    return support.call(properties.performanceAgentUrl(),
        "Manager " + managerEmployeeId + " requests confirmed team performance information. Return only confirmed data.");
  }
}
