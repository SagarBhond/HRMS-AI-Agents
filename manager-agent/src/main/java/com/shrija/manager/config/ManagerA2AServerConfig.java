...
/**
 * Exposes manager-agent as an A2A server, mirroring AttendanceA2AServerConfig /
 * LeaveA2AServerConfig. Every other sub-agent (Employee, Attendance, Leave, Payroll, HR) already
 * points a ManagerAgentClient at this URL to notify or coordinate with the People Manager role.
 */
@Configuration
