...
public class HrAgent {
  ...
  private final HrBudgetTool budgetTool;
  private final HrDocumentTool documentTool;

  public HrAgent(
      Gemini model,
      @Qualifier("hrMcpToolset") McpToolset toolset,
      HrAiProperties properties,
      HrBudgetTool budgetTool,
      HrDocumentTool documentTool) {
    geminiModel = model;
    hrMcpToolset = toolset;
  ...
  public BaseAgent build() {
    return LlmAgent.builder()
        .name("hr-agent")
        .description(
            "Main HR operations agent using MCP for HR/employee data and A2A for document and budget delegation.")
        .instruction(
            """
        ...
        .tools(
            ImmutableList.of(
                ...
                FunctionTool.create(documentTool, "createJoiningLetter"),
                FunctionTool.create(documentTool, "createOfferLetter"),
                FunctionTool.create(documentTool, "createPromotionLetter"),
                FunctionTool.create(documentTool, "createTransferLetter"),
                FunctionTool.create(documentTool, "createExperienceLetter"),
                FunctionTool.create(documentTool, "createRelievingLetter"),
                FunctionTool.create(documentTool, "createExitLetter"),
                FunctionTool.create(documentTool, "createSalaryRevisionLetter"),
                FunctionTool.create(documentTool, "createWarningLetter"),
                FunctionTool.create(documentTool, "createAppreciationLetter")))
        .build();
  }
  ...
  public HrAiProperties properties() {
    return properties;
  }
}
