...
public class DocumentAgentClient {
  ...
  public Map<String,Object> createHrDocument(String documentType, String requesterEmployeeId,
      String requesterRole, Long employeeId, String details) {
    ...
    String prompt = "Create an HR document using the Document Agent. Document type: " + documentType
        + ". Employee ID: " + employeeId + ". Requested by employee ID: " + requesterEmployeeId
        + ", role: " + requesterRole + ". Details: " + (details == null ? "" : details)
    ...
    return Map.of("created", true, "documentType", documentType, "employeeId", employeeId,
