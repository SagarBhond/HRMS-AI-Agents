...
/**
 * HR Agent-side client for sending messages back to the Orchestrator Agent over A2A — e.g.
 * escalating a request the HR Agent cannot fully resolve on its own, or reporting a status update
 * that the Orchestrator needs to relay to the end user.
 */
@Component
