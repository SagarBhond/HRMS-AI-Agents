...
public class ComplianceAgentClient
{
    private final DocumentAiProperties properties;
    private final A2AAgentClientSupport support;
    public ComplianceAgentClient(DocumentAiProperties properties, A2AAgentClientSupport support) {
        this.properties = properties; this.support = support;
    }
    public BaseAgent connect() {
        return support.connect(properties.complianceAgentUrl(), "compliance-agent", "Compliance Agent");
    }
}
