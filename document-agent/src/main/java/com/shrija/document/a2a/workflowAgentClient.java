...
public class workflowAgentClient
{
    ...
    public workflowAgentClient(DocumentAiProperties properties, A2AAgentClientSupport support) {
        this.properties = properties; this.support = support;
    }
    public BaseAgent connect() {
        return support.connect(properties.workflowAgentUrl(), "workflow-agent", "Workflow Agent");
    }
}
