...
public class DocumentAgentClient {
  ...
  public DocumentAgentClient(OrchestratorAiProperties properties, A2AAgentClientSupport support) {
  ...
  public String delegate(String groundedMessage) {
    return support.call(properties.documentAgentUrl(), groundedMessage);
  }
}
