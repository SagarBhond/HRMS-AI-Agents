...
public class WorkflowAgentClient {
  ...
  public WorkflowAgentClient(OrchestratorAiProperties properties, A2AAgentClientSupport support) {
  ...
  public String delegate(String groundedMessage) {
    return support.call(properties.workflowAgentUrl(), groundedMessage);
  }
}
