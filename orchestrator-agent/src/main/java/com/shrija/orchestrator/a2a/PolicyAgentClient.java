...
public class PolicyAgentClient {
  ...
  public PolicyAgentClient(OrchestratorAiProperties properties, A2AAgentClientSupport support) {
  ...
  public String delegate(String groundedMessage) {
    return support.call(properties.policyAgentUrl(), groundedMessage);
  }
}
