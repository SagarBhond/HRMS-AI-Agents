...
public class ComplianceAgentClient {
  ...
  public ComplianceAgentClient(OrchestratorAiProperties properties, A2AAgentClientSupport support) {
  ...
  public String delegate(String groundedMessage) {
    return support.call(properties.complianceAgentUrl(), groundedMessage);
  }
}
