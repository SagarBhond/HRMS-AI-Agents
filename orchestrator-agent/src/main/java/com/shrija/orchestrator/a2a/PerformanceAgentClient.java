...
public class PerformanceAgentClient {
  ...
  public PerformanceAgentClient(
      OrchestratorAiProperties properties, A2AAgentClientSupport support) {
  ...
  public String delegate(String groundedMessage) {
    return support.call(properties.performanceAgentUrl(), groundedMessage);
  }
}
